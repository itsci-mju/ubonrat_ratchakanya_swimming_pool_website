...
<head>
<meta charset="UTF-8">
<title>ViewRegisteredCourse</title>
</head>
</head>
<!-- CSS only -->
...
%>
	...
	<form name="frm" method="post" action="ViewRegisteredCourse" class="fit">
            ...
            <tr>
            	<td>
             	...
             	<td>
             		<div class="form-floating">
                            <input type="text" name="status" id="status" class="form-control registered"   value="<%= status %>" readonly>
                ...
                <tr>
                	<td>
                		<img src="<%= tra.get(i).getRegister_courses().getPayment_document() %>"  style="width:160px;height:230px; margin-left: 65%;">
                	</td>
                </tr>
               <tr>
               	 <td class="accept"> 
                        <a href="acceptViewRegisteredCourse?id=<%= tra.get(i).getRegister_courses().getRegister_courses_id() %>" style="color:green;">อนุมัติ</a>
                    </td>
                    <td class="decline">
                        <a href="deleteViewRegisteredCourse?id=<%= tra.get(i).getRegister_courses().getRegister_courses_id() %>" style="color:red;">ไม่อนุมัติ</a>
                    </td>
               </tr>
