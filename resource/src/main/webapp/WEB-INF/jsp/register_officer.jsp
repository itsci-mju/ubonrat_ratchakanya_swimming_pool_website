        ...
        <form:form action="${pageContext.request.contextPath}/doRegister_officer" method="post" name="regis" modelAttribute="officer">
            <section class="sect-first">
                ...
                <div class="form__group field">
                    ...
                    <form:input type="password" class="form__field" placeholder="รหัสผ่าน" path="password" id='pwd' required="required"
                        onblur="checkPassword(regis)" />
                    <div name="eye" id="eye" hidden="true"></div>
            ...
            <section class="sect-forth">
                <!--  organization   -->
                <div class="form__group field">
                    <form:select path="affiliation" id="affiliation" class="form__field select_input"
                        onblur="checkAffiliation(regis)" required="required">
                        <option value="" selected disabled hidden="true">หน่วยงาน/องค์กรที่สังกัด</option>

                        <form:options items="${officer.facname}" />

                    </form:select>
                    <label class="alert-label" id="alertFac">
                        <!-- alert_DonotForgetToDelete -->
                    </label>
                </div>
                ...
                <!--  image  -->
                <div class="request_input form__group field">
                    <label for="id_cards" class="req_file_">รูปบัตรประชาชน/ข้าราชการ</label> <br>
                ...
                <!--  ทะเบียนสมรส  -->
                <div class="request_input form__group field">
                    <label for="marriage" class="req_file_">ทะเบียนสมรส</label> <br>
                    <form:input type="file" path="marriage_cer" id="marriage" class="req_file form-control"
                        onblur="uploadMarriage(regis)" />
                    <br>
                    <label class="alert-label" id="alertmarriage">
                        <!-- alert_DonotForgetToDelete -->
                    </label>
                </div>
