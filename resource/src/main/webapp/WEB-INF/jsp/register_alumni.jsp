...
<div class="re-content">
    <form action="doRegister_alumni" method="post" name="regis">
        <p style="font-size: 26px; margin: auto;" align="center"> สมัครสมาชิก : ศิษย์เก่า </p>
        ...
        <section id="sec_second">
            ...
            <div class="request_input form__group field">
                <label for="doc" class="req_file_">รูปบัตรศิษย์เก่า</label> <br>
...
function uploadPer_pic(regis) { 
  ...
  if(regis.per_pic.value==("")){
	  labelAlertper_pic.innerText="กรุณาใส่รูปบัตรศิษย์เก่า";
