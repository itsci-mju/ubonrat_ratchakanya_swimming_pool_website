...
<div class="re-content">
    <form action="doRegister_staff" method="post" name="regis">
    ...
    <!-- personal image profile -->
            <div class="request_input form__group field">
                <label for="per_pic" class="req_file_">รูปบัตรประชาชน/ข้าราชการ</label> <br>
...
function uploadPer_pic(regis) { 
  ...
  if(regis.per_pic.value==("")){
	  labelAlertper_pic.innerText="กรุณาใส่รูปบัตรประชาชน/ข้าราชการ";
