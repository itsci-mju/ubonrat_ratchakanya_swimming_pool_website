...
<div class="re-content">
    <form:form action="${pageContext.request.contextPath}/doRegister_staff" method="post" name="regis" modelAttribute="staff">
        ...
        <div class="form__group field">
            <form:input type="text" class="form__field" placeholder="ชื่อ" path="firstname" id='fname' onblur="checkFirstname(regis)" />
        ...
        <!-- Last Name-->
        <div class="form__group field">
            <form:input type="text" class="form__field" placeholder="นามสกุล" path="lname" id='lname' onblur="checkLastname(regis)" />
        ...
        <!-- Email -->
        <div class="form__group field">
            <form:input type="text" class="form__field" placeholder="อีเมล" path="email" id='email' onblur="checkEmail(regis)" />
        ...
        <div class="form__group field">
            ...
            <form:input type="password" class="form__field" placeholder="รหัสผ่าน" path="pwd" id='pwd' required onblur="checkPassword(regis)" />
            <div type="checkbox" name="eye" id="eye" hidden></div>
        ...
        <section id="sec_second">
            ...
            <div class="form__group field">
                ...
                <form:radiobutton  path="gender" id="gender_m" value="male" required="required" /> ชาย 
                <form:radiobutton  path="gender" id="gender_f" value="female" /> หญิง
                <label class="alert-label" id="alertGender"><!-- alert_DonotForgetToDelete --></label>
            </div> 
             <!-- Tel. Number-->
             <div class="form__group field">
                <form:input type="tel" class="form__field" placeholder="เบอร์โทรศัพท์" path="tel" id='tel' maxlength="10" onblur="checkTel(regis)" />
            ...
            <!-- Birth date-->
            <div class="form__group field">
                <form:input type="date" class="form__field" path="birthdate" id='birthdate' value="21-12-1998" onblur="checkBirth(regis)" />
            ...
            <div class="form__group field">
                <form:input type="text" class="form__field" placeholder="ที่อยู่" path="address" id='address' onblur="checkAddrss(regis)" />
            ...
            <div class="form__group field">
                <form:input type="text" class="form__field" placeholder="ตำบล" path="sub_districts" id='sub_districts' onblur="checkSub_districts(regis)"/>
                <label for="sub_districts" class="form__label">ตำบล</label>
                <label class="alert-label" id="alertsubD"><!-- alert_DonotForgetToDelete --></label>
            </div>
            <div class="form__group field">
                <form:input type="text" class="form__field" placeholder="อำเภอ" path="districts" id='districts' onblur="checkDistricts(regis)"/>
                <label for="districts" class="form__label">อำเภอ</label>
                <label class="alert-label" id="alertDist"><!-- alert_DonotForgetToDelete --></label>
            </div>
            <div class="form__group field">
                <form:input type="text" class="form__field" placeholder="จังหวัด" path="province"  id='province' onblur="checkProvince(regis)"/>
            ...
            <div class="form__group field">
                <form:input type="text" class="form__field" placeholder="รหัสไปรษณีย์" path="post_code" id='post_code' onblur="checkPost_code(regis)"/>
        ...
        <section id="sec_third">
            <!--  organization   -->
            <div class="form__group field">
            <form:select path="affiliation" id="affiliation" class="form__field" onblur="checkAffiliation(regis)">
                <option value="" selected disabled hidden>หน่วยงาน/องค์กรที่สังกัด</option>
           
               <form:options items="${officer.facname}" />
            ...
            <div class="request_input form__group field">
                ...
                <form:input type="file" path="per_pic" id="per_pic" class="req_file form-control" onblur="uploadPer_pic(regis)"/>
            <br>
            ...
            <div class="request_input form__group field">
                ...
                <form:input type="file" path="id_cards" id="id_cards" class="req_file form-control" onblur="uploadId_cards(regis)"/> 
            <br>
