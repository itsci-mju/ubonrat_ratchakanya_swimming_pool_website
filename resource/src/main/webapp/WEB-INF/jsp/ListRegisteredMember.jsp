<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	ListRegisteredMemberManager lr = new ListRegisteredMemberManager();    
    	List<Members> mes =  lr.getListRegisteredMember();
    	
    	
    	
    	ListRegisteredMemberManager lrs = new ListRegisteredMemberManager();    
    	List<Members> mes2 =  lrs.getListRegisteredMemberForManagerApproveStatus1();
...
<head>
<meta charset="UTF-8">
<title>ดูรายการผู้ที่สมัครสมาชิกเข้ามา</title>
</head>
        ...
        <table class="manage_table">
            ...
            <% for(Members m:mes) { %>
                <tr align="center">
                    ...
                    <td align="center">
                        <a href="ViewMemberDetail"  role="button" style="color:black;">ดูเพิ่มเติม</a>
                    </td>                       
                </tr>
                <% } %>              
            </tbody>
            ...
            <tfoot class="column-table"> 
                <tr align="center">
                    <td colspan="6" style="background-color: rgb(230, 230, 230,0.8);">
                        &nbsp;สมาชิกที่ยังไม่ผ่านการยืนยันจาก Manager	
                    </td>
            ...
            <table class="manage_table">
               ...
               <tbody class="column-table">
                ...
                <tr align="center">
                    <td align="left">
                        <div class="nameid">
                            <%= ms.getLogins().getMembers_id() %>
                        </div>
                    </td>
                    <td align="left">
                    	<div class="nameid1"> 
                        <%= ms.getFirstname() %> - <%= ms.getLastname() %>
                        </div>
                    </td>
                    ...
                    <% 
                    String strDate = dateFormat.format(ms.getStartcarddate().getTime().getTime());
                   	 if (strDate.equals("0002-11-30")) {%>
                    
                    	<td align="center">
                       		 <a href="PrintMemberCard?mid=<%= ms.getLogins().getMembers_id() %>"  role="button" style="color:black;">จัดทำบัตรสมาชิก</a>         
                    	</td>   
                    	
                    <%} else {%>
                    	<td align="center">
                       		 <a href="PrintMemberCard?mid=<%= ms.getLogins().getMembers_id() %>"  role="button" style="color:blue;">ดูบัตรสมาชิก</a>         
                    	</td> 
                    	
                    	<td align="center">
                       		 <a href="PrintMemberCard?mid=<%= ms.getLogins().getMembers_id() %>"  role="button" style="color:red;">ต่ออายุบัตรสมาชิก</a>         
                    	</td>
                    <% } %>   
             ...
             <tfoot class="column-table"> 
                <tr align="center">
                    <td colspan="6" style="background-color: rgb(230, 230, 230,0.8);">
                        &nbsp;สมาชิกที่ผ่านการยืนยันจาก Manager แล้ว
                    </td>
